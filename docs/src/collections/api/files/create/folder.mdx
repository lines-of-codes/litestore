---
title: /api/files/create/folder
method: POST
summary: Create Directory
description: An API route for creating a directory
---
...
| ---- | -------- | -------- | ------------------------------------ |
| path | `string` | Yes      | The path of the folder being created |
...
```json
{
    ...
    "message": "An error occurred while creating the folder in database"
}
```
    </Tab>
</Tabs>
